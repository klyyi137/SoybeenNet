...
public sealed class SqlSugarRepository<TEntity> where TEntity : class, new()
{
    private readonly string[] _updateIgnoreColumns = ["CreatedTime", "CreatedUserId", "CreatedUserName"];
    ...
    /// <param name="entity"></param>
    /// <returns></returns>
    public async Task<long> InsertReturnSnowflakeIdAsync(TEntity entity)
    {
    ...
    /// <returns>仓储</returns>
    public SqlSugarRepository<T> Change<T>()
        where T : class, new()
    {
